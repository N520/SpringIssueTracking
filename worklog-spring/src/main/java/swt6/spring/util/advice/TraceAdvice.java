...
public class TraceAdvice {
	...
	//reuseable
	@Pointcut("execution(public * swt6.spring.logic.IssueTrackingDal.find*(..))")
	private void findMethods() {
	}

//	@Before("execution(public * swt6.spring.basics.aop.logic..*find*(..))")
	@Before("swt6.spring.util.advice.TraceAdvice.findMethods()")
...
//	@AfterThrowing(pointcut="swt6.springaop.advice.TraceAdvice.findMethods()", throwing = "ex")
